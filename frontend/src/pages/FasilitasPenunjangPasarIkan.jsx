...
const FasilitasPenunjangPasarIkan = () => {
  ...
  const JENIS_FASILITAS_UMUM_OPTIONS = ['Pasar Basah', 'Pasar Kering', 'Tempat Lelang', 'Los Ikan']
  ...
  const TIPS = {
    ...
    jenisFasilitasUmum: 'Pilih jenis fasilitas pasar ikan.',
  ...
  return (
    <div className="section-card">
      <FormHeader
        title="Fasilitas Penunjang - Pasar Ikan"
        description="Form Pasar Ikan"
        rightSlot={(
...
export default FasilitasPenunjangPasarIkan