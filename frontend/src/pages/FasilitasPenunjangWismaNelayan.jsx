...
const FasilitasPenunjangWismaNelayan = () => {
  ...
  return (
    <div className="section-card">
      <FormHeader
        title="Fasilitas Penunjang - Wisma Nelayan"
        description="Form Wisma Nelayan"
        rightSlot={(
...
export default FasilitasPenunjangWismaNelayan