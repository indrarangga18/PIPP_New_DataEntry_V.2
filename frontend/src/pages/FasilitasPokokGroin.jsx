...
const FasilitasPokokGroin = () => {
  ...
  const TIPS = {
    ...
    keteranganKonstruksi: 'Kondisi/keterangan konstruksi saat ini.',
  ...
  const isRequiredEmpty = createIsRequiredEmpty(formData, {
    textKeys: ['pelabuhan','tahunPembuatan','jenisKonstruksi','sumberDana','nilai'],
    numericKeys: ['panjang','lebar','elevasi','jumlahGroin','jarakGroin']
  })
  const saveDisabled = createIsSaveDisabled(isRequiredEmpty, ['pelabuhan','tahunPembuatan','jenisKonstruksi','panjang','lebar','elevasi','jumlahGroin','jarakGroin','sumberDana','nilai'])
        ...
        <div className="form-grid">
          ...
          <div className="form-group" style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            <label className="form-label">Keterangan Rehab
              <span className="tooltip-trigger" role="button" aria-label={TIPS.keteranganRehab} onMouseEnter={() => toggleTip('keteranganRehab')} style={{ color: '#6b7280', fontWeight: 600, fontSize: 12, marginLeft: 6, cursor: 'help', padding: 0, display: 'inline-block' }}>?</span>
            </label>
            ...
            <input type="text" name="keteranganRehab" value={formData.keteranganRehab} onChange={handleInputChange} className="form-input" placeholder="Contoh: Perkuatan struktur" />
          </div>
          ...
          <div className="form-group" style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            ...
            <input type="number" name="rencanaPengembanganPanjang" value={formData.rencanaPengembanganPanjang} onChange={handleInputChange} className="form-input" placeholder="Contoh: 10" step="0.01" min="0" />
          </div>
          ...
          <div className="form-group" style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            ...
            <input type="number" name="rencanaPengembanganLebar" value={formData.rencanaPengembanganLebar} onChange={handleInputChange} className="form-input" placeholder="Contoh: 1" step="0.01" min="0" />
          </div>
          ...
          <div className="form-group" style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            <label className="form-label">Keterangan Konstruksi
              <span className="tooltip-trigger" role="button" aria-label={TIPS.keteranganKonstruksi} onMouseEnter={() => toggleTip('keteranganKonstruksi')} style={{ color: '#6b7280', fontWeight: 600, fontSize: 12, marginLeft: 6, cursor: 'help', padding: 0, display: 'inline-block' }}>?</span>
            </label>
            ...
            <select name="keteranganKonstruksi" value={formData.keteranganKonstruksi} onChange={handleInputChange} className="form-select">
          ...
          <div className={`form-group ${isRequiredEmpty('sumberDana') ? 'error' : ''} ${isRequiredEmpty('sumberDana') && doShake ? 'shake' : ''}`} style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            ...
            <input type="text" name="sumberDana" value={formData.sumberDana} onChange={handleInputChange} className="form-input" placeholder="Contoh: APBN, APBD, Hibah" required />
          </div>
          ...
          <div className="form-group full-width" style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            <label className="form-label">Keterangan Sumber Dana
              <span className="tooltip-trigger" role="button" aria-label={TIPS.keteranganSumberDana} onMouseEnter={() => toggleTip('keteranganSumberDana')} style={{ color: '#6b7280', fontWeight: 600, fontSize: 12, marginLeft: 6, cursor: 'help', padding: 0, display: 'inline-block' }}>?</span>
            </label>
            ...
            <input type="text" name="keteranganSumberDana" value={formData.keteranganSumberDana} onChange={handleInputChange} className="form-input" placeholder="Contoh: Tahap II, dana matching dari KKP" />
          </div>
          ...
          <div className={`form-group full-width ${fileError ? 'error' : ''}`} style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            <label className="form-label">Gambar
              <span className="tooltip-trigger" role="button" aria-label={TIPS.gambar} onMouseEnter={() => toggleTip('gambar')} style={{ color: '#6b7280', fontWeight: 600, fontSize: 12, marginLeft: 6, cursor: 'help', padding: 0, display: 'inline-block' }}>?</span>
            </label>
            {openTip === 'gambar' && (
              <div role="dialog" aria-label="Informasi pengisian" style={{ position: 'absolute', top: 6, right: 8, background: '#fff', color: '#111', border: '1px solid #e5e7eb', borderRadius: 6, boxShadow: '0 8px 24px rgba(0,0,0,0.15)', padding: '8px 10px', maxWidth: 260, zIndex: 20 }}>
          ...
          <div className={`form-group ${isRequiredEmpty('aktif') ? 'error' : ''}`} style={{ position: 'relative' }} onMouseLeave={() => setOpenTip(null)}>
            <label className="form-label">Aktif <span className="required-mark">*</span>
              <span className="tooltip-trigger" role="button" aria-label={TIPS.aktif} onMouseEnter={() => toggleTip('aktif')} style={{ color: '#6b7280', fontWeight: 600, fontSize: 12, marginLeft: 6, cursor: 'help', padding: 0, display: 'inline-block' }}>?</span>
            </label>
            {openTip === 'aktif' && (
              <div role="dialog" aria-label="Informasi pengisian" style={{ position: 'absolute', top: 6, right: 8, background: '#fff', color: '#111', border: '1px solid #e5e7eb', borderRadius: 6, boxShadow: '0 8px 24px rgba(0,0,0,0.15)', padding: '8px 10px', maxWidth: 260, zIndex: 20 }}>
