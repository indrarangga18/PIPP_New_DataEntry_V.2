...
const FasilitasFungsionalPemeliharaanAlatTangkap = () => {
  ...
  const JENIS_FASILITAS_OPTIONS = ['Bengkel Alat Tangkap', 'Gudang Alat Tangkap', 'Penjemuran Jaring', 'Perbaikan Jaring']
  ...
  const TIPS = {
    ...
    jenisFasilitas: 'Pilih jenis fasilitas pemeliharaan alat tangkap.',
  ...
  const handleSubmit = (e) => {
    ...
    alert('Data Pemeliharaan Alat Tangkap tersimpan (mock).')
  }

  return (
    <div className="section-card">
      <FormHeader
        title="Fasilitas Fungsional - Pemeliharaan Alat Tangkap"
        description="Form untuk mengelola fasilitas pemeliharaan alat tangkap"
        rightSlot={(
...
export default FasilitasFungsionalPemeliharaanAlatTangkap