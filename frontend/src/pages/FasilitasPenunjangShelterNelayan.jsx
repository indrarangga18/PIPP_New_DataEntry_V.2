...
const FasilitasPenunjangShelterNelayan = () => {
  ...
  const JENIS_FASILITAS_UMUM_OPTIONS = ['Shelter Terbuka', 'Shelter Tertutup', 'Gazebo', 'Pos Jaga']
  ...
  return (
    <div className="section-card">
      <FormHeader
        title="Fasilitas Penunjang - Tempat Istirahat/Shelter Nelayan"
        description="Form Shelter Nelayan"
        rightSlot={(
...
export default FasilitasPenunjangShelterNelayan