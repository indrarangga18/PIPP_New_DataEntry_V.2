...
const FasilitasFungsionalFasilitasKomunikasi = () => {
  ...
  const JENIS_FASILITAS_OPTIONS = ['Internet', 'Lampu Suar', 'Line Telepon', 'Menara Pengawas', 'Radio SSB', 'Rambu-Rambu Pelayaran']

  const TIPS = {
    pelabuhan: 'Pilih pelabuhan tempat fasilitas berada.',
    tahunPembuatan: 'Tahun pembuatan (tahun saja).',
    jenisFasilitas: 'Pilih jenis fasilitas.',
    jumlah: 'Jumlah unit.',
  ...
  const handleSubmit = (e) => {
    ...
    alert('Data Fasilitas Komunikasi tersimpan (mock).')
  }

  return (
    <div className="section-card">
      <FormHeader
        title="Fasilitas Fungsional - Fasilitas Komunikasi"
        description="Form untuk mengelola fasilitas komunikasi"
        rightSlot={(
        ...
        <div className="form-grid">
          ...
          <div className="form-actions">
            ...
            <button
              ...
              onClick={() => setFormData({
                pelabuhan: '', tahunPembuatan: '', jenisFasilitas: '', jumlah: '', rencanaPengembanganJumlah: '', keteranganTeknis: '', gambar: null, aktif: true,
              })}
            >Hapus Isian</button>
          </div>
        </div>
...
export default FasilitasFungsionalFasilitasKomunikasi